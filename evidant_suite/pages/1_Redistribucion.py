...
<div style="display:flex;align-items:center;gap:0.8rem;margin-bottom:0.5rem;">
  ...
  <div>
    <div style="font-family:'Plus Jakarta Sans',sans-serif;font-size:1.6rem;font-weight:800;
      ...
      Redistribución PRAPS vs DAP
    </div>
    <div style="font-size:0.8rem;color:#6b8caf;">
      Módulo 1 &nbsp;·&nbsp; Redistribución de remuneraciones por centro de costo
    </div>
  </div>
</div>
<hr/>
...
if st.button("⚡  GENERAR REDISTRIBUCIÓN", type="primary", use_container_width=True):
    try:
        with st.spinner("Procesando... (puede tardar si el Excel es muy grande)"):
            uploaded.seek(0)
