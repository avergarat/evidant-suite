...
<div style="display:flex;align-items:center;gap:0.8rem;margin-bottom:0.5rem;">
  ...
  <div>
    <div style="font-family:'Plus Jakarta Sans',sans-serif;font-size:1.6rem;font-weight:800;
                background:linear-gradient(135deg,#e8f0fe,#0098ff);
                -webkit-background-clip:text;-webkit-text-fill-color:transparent;">
      SEGUNDO PASO: Procesamiento para Centralización de Gastos
    </div>
    <div style="font-size:0.8rem;color:#6b8caf;">
      Paso 2 de 2 &nbsp;·&nbsp; PF CASA · SIGFE por Centro de Costo · Hojas PF_MES y PF_ANUAL
    </div>
  </div>
</div>
<hr/>
...
if st.button("⚡  GENERAR PROGRAMA FINANCIERO", type="primary", use_container_width=True):
    ...
    try:
        with st.spinner("Procesando... (puede tardar varios minutos en archivos grandes)"):
